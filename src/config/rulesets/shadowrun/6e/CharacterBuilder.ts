...
export class CharacterBuilder implements Builder<Character> {
    ...
    setPriorities(metatype: PriorityRank, attributes: PriorityRank, skills: PriorityRank, magic: PriorityRank, resources: PriorityRank): CharacterBuilder {
        ...
        this.magicPoints = this.magetype === 'Mundane' ? 0 : (PriorityOptions.Magic[magic] as MagicPriorities)[this.magetype];
...
type Magetype = 'Full' | 'Aspected' | 'MysticAdept' | 'Adept' | 'Technomancer' | 'Mundane';
